  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Stack(
          children: [
            // Main content scrolled separately
            SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  // Preview Section (White Container)
                  Container(
            ...
            // AppBar Section (positioned at the top)
            Container(
              height: 120, // Increased height to match the settings page
              width: double.infinity,
              decoration: BoxDecoration(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 8),
                  // Title and Subtitle - Using Expanded to prevent overflow
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 20, // Reduced from 24 to help with overflow
                        ...
                        Text(
                          widget.documentType,
                          style: TextStyle(
                            fontSize: 12, // Reduced from 14 to help with overflow
