...
class DateTimeSelectionScreen extends StatefulWidget {
  ...
  const DateTimeSelectionScreen({Key? key, this.workingHours = const []})
    : super(key: key);
...
class _DateTimeSelectionScreenState extends State<DateTimeSelectionScreen> {
  ...
  bool _isPastTimeForToday(String timeString) {
    ...
    int minute =
        int.tryParse(
          hourMinute[1].replaceAll(' AM', '').replaceAll(' PM', ''),
        ) ??
        0;
            ...
            Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment
                    .spaceBetween, // Changed to space between for back button and title
                children: [
                  ...
                  const SizedBox(
                    width: 24,
                  ), // Matching the width of the back button
                ],
              ),
            ),
                    ...
                    children: [
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  color: isSelected
                                      ? const Color(
                                          0xFF2F80ED,
                                        ) // Solid Bright Blue for selected date
                                      : Colors.transparent,
                                  shape: BoxShape
                                      .circle, // Changed to circle for selected date
                                ),
                                child: Center(
                                  child: Text(
                                    date.day.toString(),
                                    style: TextStyle(
                                      color: isPast
                                          ? const Color(
                                              0xFFA0A0A0,
                                            ) // Darker grey for past dates
                                          : !isCurrentMonth
                                          ? const Color(
                                              0xFFA0A0A0,
                                            ) // Darker grey for dates from other months
                                          : isSelected
                                          ? Colors
                      ...
                      SizedBox(
                        ...
                        child: GridView.builder(
                          ...
                          itemCount: timeSlots.isEmpty
                              ? 2
                              : timeSlots
                                    .length, // Show 2 default slots if empty
                          itemBuilder: (context, index) {
                            final String time;
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  color: isSelected
                                      ? const Color(
                                          0xFF2F80ED,
                                        ) // Solid Bright Blue for selected
                                      ...
                                      : [
                                          ...
                                          BoxShadow(
                                            color: Colors.grey.withOpacity(
                                              0.2,
                                            ), // Increased opacity from 0.1 to 0.2
                                            spreadRadius: 1,
                                            blurRadius:
                                                6, // Increased blur radius for more depth
                                            offset: const Offset(
                                              0,
                                              3,
                                            ), // Increased offset for more depth
                                          ),
                                        ],
                                ),
                                child: Center(
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      fontWeight: isSelected
                                          ? FontWeight
                                                .w700 // Bold for selected
                                          : FontWeight
                                                .w500, // Regular for unselected
                                      fontSize: 14,
                                    ),
                                  ),
                                ),
                      ...
                      // Appointment button moved from bottomNavigationBar
                      Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            if (selectedTime != null) {
                              ...
                              // Show error if no time is selected
  ...
  // Helper method to format the selected date for display
  ...
  // Helper method to get doctor name from route arguments
